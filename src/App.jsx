            ...
            <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" value={draftForm.targetAudience} onChange={e => setDraftForm(f => ({ ...f, targetAudience: e.target.value }))} placeholder="z.B. Mitglieder, Eltern" className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-200 outline-none text-sm" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-600 mb-1">Kommunikationsziel</label>
                  <input type="text" value={draftForm.goal} onChange={e => setDraftForm(f => ({ ...f, goal: e.target.value }))} placeholder="z.B. Informieren, Einladen" className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-200 outline-none text-sm" />
                </div>
                <div>
        ...
        {view === "settings" && (
          <div className="animate-fade-in max-w-2xl mx-auto space-y-5">
            ...
            {settingsTab === "templates" && (
              <div className="space-y-3">
                <p className="text-xs text-slate-500">Vorlagen für wiederkehrende Anlässe (z.B. Spielbericht, Saisonstart). Sie belegen Sparte, Tonalität und Kanäle vor.</p>
